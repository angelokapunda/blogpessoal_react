...
async function cadastarNovoUsuario(e : FormEvent<HTMLFormElement>) {
    e.preventDefault();
    if(confirmaSenha === usuario.senha && usuario.senha.length >= 8) {
        ...
        try {
            ...
            alert("Eroo ao cadastrar o usuário")
            console.error(error)
        }
    } else {
        alert("Dados do Usuário estão inconsistentes, verifique as informações do cadastro.")
        setUsuario({
            ...usuario,
            senha:""
        })
...
console.log(confirmaSenha);
  ...
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 h-screen 
        ...
        <form className='flex justify-center items-center flex-col w-2/3 gap-3' onSubmit={cadastarNovoUsuario}>
